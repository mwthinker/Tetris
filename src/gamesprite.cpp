...
const mw::Sprite spriteMan(textureSquares,       64, 1, 62, 62);
const mw::Sprite spriteComputer(textureSquares, 448, 65, 62, 62);
const mw::Sprite spriteCross(textureSquares,      1, 1, 62, 62);
